...
public class ServerUpdate 
{
	...
	public static void main(String[] args) throws Exception 
	{
		...
		server.createContext("/create", new Create());//to create a new wishlist
		server.createContext("/post", new Post());//for a user to login
		server.createContext("/deleteWishlist", new DeleteW());//delete a wishlist
		server.createContext("/addProduct",new AddPrd());// add a product
		server.createContext("/addFullfiller",new AddF());// add new fullfiller
		server.createContext("/deletePrd",new DeletePrd());// Delete Product
		server.createContext("/updatePQty",new UpdatePQty()); //Update Qty
		server.createContext("/updateFQty",new UpdateFQty());// Update fullfiller Qty
		server.createContext("/deleteF",new DeleteF());// delete fullfiller
	...
	public static class DeletePrd implements HttpHandler 
	{
		...
		public void handle(HttpExchange he) throws IOException {
			...
			String response="";
			DeleteProduct a1=new DeleteProduct();
	...
	public static class AddF implements HttpHandler 
	{
		...
		public void handle(HttpExchange he) throws IOException {
			...
			AddFullfiller a1 = new AddFullfiller();
			String response = "";
	...
	public static class DeleteF implements HttpHandler 
	{
		...
		public void handle(HttpExchange he) throws IOException
		{
			...
			DeleteFullfiller a1 = new DeleteFullfiller();
			String response = "";
	...
	public static class UpdateFQty implements HttpHandler 
	{
		...
		public void handle(HttpExchange he) throws IOException
		{
			...
			UpdateFQuantity WishList = new UpdateFQuantity();
			String response = "";
	...
	public static class UpdatePQty implements HttpHandler 
	{
		...
		public void handle(HttpExchange he) throws IOException 
		{
			...
			UpdatePQuantity WishList = new UpdatePQuantity();
			String response = "";
	...
	static class Get implements HttpHandler
	{
		public void handle(HttpExchange httpExchange) throws IOException 
		{
			...
			Map<String, String> parms = ServerUpdate.queryToMap(httpExchange.getRequestURI().getQuery());
			response.append("<html><body>");
			response.append("ProductQty : " + parms.get("Qty1") + "<br/>");
			response.append("ProductDate : " + parms.get("Date") + "<br/>");
			response.append("</body></html>");
			ServerUpdate.writeResponse(httpExchange, response.toString());
